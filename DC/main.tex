...
\begin{figure}[!t]
\centering
\lstinputlisting[basicstyle=\ttfamily\tiny, frame=single, breaklines=true, columns=flexible, linerange={1-50}]{images/logs/scenario1_success.txt}
...
\begin{figure}[!t]
\centering
\lstinputlisting[basicstyle=\ttfamily\tiny, frame=single, breaklines=true, columns=flexible, linerange={1-55}]{images/logs/scenario2_master_failure.txt}
...
\begin{figure}[!t]
\centering
\lstinputlisting[basicstyle=\ttfamily\tiny, frame=single, breaklines=true, columns=flexible, linerange={1-55}]{images/logs/scenario3_replica_failure.txt}
...
\begin{figure}[!t]
\centering
\lstinputlisting[basicstyle=\ttfamily\tiny, frame=single, breaklines=true, columns=flexible, linerange={1-55}]{images/logs/scenario4_timestamp_failure.txt}
