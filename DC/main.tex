...
\begin{tikzpicture}[scale=0.7, transform shape]
    ...
    \node[font=\tiny, align=left] at (0,-0.8) {consistency = ``strong''};
...
\begin{itemize}
    ...
    \item Strong consistency requires 2 of 3 replicas to acknowledge (Cabinet quorum)
\end{itemize}
...
curl -X POST http://localhost:8000/query \
  ...
  -d '{"sql": "INSERT INTO users (name) VALUES ('TestUser')", "consistency": "strong"}'
    \end{lstlisting}
...
# Returns latencies: replica-1: 12ms, replica-2: 7ms, replica-3: 6ms
    ...
    \begin{lstlisting}[language=bash]
curl -X POST http://localhost:8000/query \
  -d '{"sql": "SELECT * FROM users", "consistency": "eventual"}'
    \end{lstlisting}
...
docker stop mysql-master
    ...
    \begin{lstlisting}[language=bash]
curl -X POST http://localhost:8000/query \
  -d '{"sql": "INSERT INTO users (name) VALUES ('AfterFailover')", "consistency": "strong"}'
    \end{lstlisting}
